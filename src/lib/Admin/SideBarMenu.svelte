...
<div class="border-r-[1px] border-gray-200 h-full hidden md:block">
	...
	<ul class="menu text-neutral">
		<li class:bordered={activeMenu === admin_menus.OVERVIEW}>
			<a href={`#${admin_menus.OVERVIEW}`} class="hover:bg-primary hover:text-white">Compte rendu</a
			>
		</li>
...
<div class="block md:hidden px-8 mt-10 mb-10">
	...
	{#if isMobileMenuOpened}
		<div class="h-fit border-b-[1px] border-x-[1px] border-gray-200">
			<ul class="menu text-neutral">
				<li class:bordered={activeMenu === admin_menus.OVERVIEW}>
					<a href={`#${admin_menus.OVERVIEW}`} class="hover:bg-primary hover:text-white"
						>Compte rendu</a
					>
				</li>
				<li class:bordered={activeMenu === admin_menus.FLIGHTS}>
