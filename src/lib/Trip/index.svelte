...
<div class="px-8 lg:px-16">
	<div class="container">
		<div class="flex flex-col w-fit">
			<h2 class="text-xl lg:text-2xl font-bold text-neutral uppercase">Nos offres de voyages</h2>
		...
		<div class="mt-16">
			...
			{#if loading}
				<div class="flex justify-center">
					<svg
						role="status"
						class="mr-2 w-8 h-8 text-primary animate-spin dark:text-neutral fill-primary"
						viewBox="0 0 100 101"
						fill="none"
			...
			{#if flights.length < total}
				<div class="flex justify-center items-center mt-20">
					<button
						class="btn btn-primary rounded-full w-48 text-xs mb-10"
