...
>
	<div class="hover:bg-neutral/50 w-full h-full flex flex-col items-center justify-center">
		<h1 class="text-white font-bold text-md lg:text-2xl text-center">{island_name}</h1>
