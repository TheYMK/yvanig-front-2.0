		...
		<div class="flex justify-center items-center h-full">
			<div class="auth-card bg-white w-[400px] h-fit md:rounded-[15px] p-8">
				<div id="title" class="text-center">
					<h1 class="font-bold text-neutral">Se Connecter</h1>
				</div>
					...
					<form class="space-y-4">
						...
						<div>
							<a
								...
								class="text-neutral font-bold text-xs hover:text-primary">Mot de passe oublié ?</a
							>
						</div>
						...
						<div class="text-center">
							...
							{#if errors.email || errors.password}
								<div>
									...
									<p class="text-red-600 text-xs mt-4">{errors.password}</p>
								</div>
							{/if}
						</div>
