					...
					<div class="grid grid-cols-1 lg:grid-cols-2 gap-2">
						<div class="col-span-2 lg:col-span-1">
							<Input
								...
								value={data.name}
								on:input={(e) => (data = { ...data, name: e.target.value })}
							/>
						</div>
						<div class="col-span-2 lg:col-span-1">
							<Input
						...
						<div class="col-span-2 lg:col-span-2">
							<Input
								...
								value={data.subject}
								on:input={(e) => (data = { ...data, subject: e.target.value })}
							/>
						</div>
						<div class="col-span-2 lg:col-span-2">
							...
							<textarea
								name="message"
								id="message"
								class="input h-24 input-bordered border-neutral w-full border-black"
								placeholder="J'ai un problème avec...."
								value={data.message}
								on:input={(e) => (data = { ...data, message: e.target.value })}
							/>
						</div>
