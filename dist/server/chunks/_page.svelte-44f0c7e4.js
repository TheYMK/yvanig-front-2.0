...
${validate_component(Layout, "Layout").$$render($$result, {}, {}, {
	...
	<div class="${"h-screen lg:px-16"}"><div class="${"flex justify-center items-center h-full"}"><div class="${"auth-card bg-white w-[500px] h-fit md:rounded-[15px] p-8 mt-52 lg:mt-0 svelte-1sga2pc"}"><div id="${"title"}" class="${"text-center"}"><h1 class="${"font-bold text-neutral"}">Cr\xE9ez votre compte</h1></div>
        ...
        {}
						...
						<div class="${"text-center col-span-2"}"><button ${"disabled"} class="${"btn btn-primary rounded-full w-48 text-xs mt-4"}">${`<span>Cr\xE9er mon compte</span>`}</button>
...
//# sourceMappingURL=_page.svelte-44f0c7e4.js.map
