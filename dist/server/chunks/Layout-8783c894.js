...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { darkLink = false } = $$props;
  let y;
  if ($$props.sticky === void 0 && $$bindings.sticky && sticky !== void 0)
    $$bindings.sticky(sticky);
  if ($$props.darkLink === void 0 && $$bindings.darkLink && darkLink !== void 0)
    $$bindings.darkLink(darkLink);
  $$result.css.add(css);
...
<nav id="${"navbar"}" class="${[
    ...
    "text-white lg:hidden w-fit-content py-10 px-6 self-end hover:text-white",
    "hidden"
					...
					<div class="${"flex flex-col items-center lg:flex-row " + escape(
    darkLink ? `text-neutral ${y >= 50}` : "text-white",
    true
  )}"><a href="${"/"}"${add_attribute(
    "class",
    ...
    0
						...
						<div class="${"lg:ml-5"}">${$userStore ? `${$userStore.role === "sysadmin" ? `<div class="${"text-neutral dropdown dropdown-end dropdown-hover"}"><div tabindex="${"0"}"${add_attribute(
    "class",
    ...
    0
										...
										<ul tabindex="${"0"}" class="${"menu dropdown-content p-2 shadow bg-base-100 rounded-box w-52"}"><li><a href="${"/admin/account"}" class="${"hover:bg-primary hover:text-white"}">Tableau de bord</a></li>
											<li><a href="${"/auth/signout"}" class="${"hover:bg-primary hover:text-white"}">D\xE9connexion</a></li></ul></div>` : `<div class="${"text-neutral dropdown dropdown-end dropdown-hover"}"><div tabindex="${"0"}" href="${"/user/account"}"${add_attribute(
    "class",
    `btn rounded-full btn-sm text-xs w-40 border-none ${"bg-white hover:bg-white text-neutral"}`,
    0
  )}>Mon compte
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<footer class="${"p-10 footer bg-white border-t-[1px] border-gray-200 text-neutral"}"><div><span class="${"footer-title"}">Nos Services</span>
		...
		<a href="${"/services"}" class="${"hover:text-primary"}">Visa et h\xE9b\xE9rgement</a>
		<a href="${"/services"}" class="${"hover:text-primary"}">Locations de voiture</a></div>
	...
	<div><span class="${"footer-title"}">Autres</span>
		<a href="${"/legal-mentions"}" class="${"hover:text-primary"}">Mentions l\xE9gales</a>
		<a href="${"/privacy"}" class="${"hover:text-primary"}">Politique de confidentialit\xE9 </a></div></footer>
...
//# sourceMappingURL=Layout-8783c894.js.map
