...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let data = { email: "" };
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-q8u3qw_START -->${$$result.title = `<title>Yvanig Agency - S&#39;enregistrer</title>`, ""}<!-- HEAD_svelte-q8u3qw_END -->`, ""}
...
//# sourceMappingURL=_page.svelte-634e4eb3.js.map
