...
const css$3 = {
  code: ".background-image.svelte-1q4symm{background-image:linear-gradient(360deg, var(--color-base-100) 0%, rgba(255, 18, 250, 0) 10%),\n			url('/src/assets/bg/bg_hero.webp');background-color:var(--color-base-100);background-repeat:no-repeat;background-size:cover}.reservation-card.svelte-1q4symm{box-shadow:0px 0px 8px 0px rgba(0, 0, 0, 0.3);-webkit-box-shadow:0px 0px 8px 0px rgba(0, 0, 0, 0.3);border-top:solid 1px rgba(255, 255, 255, 0.1)}",
  map: null
};
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"min-h-screen background-image px-8 lg:px-16 svelte-1q4symm"}"><div class="${"container flex flex-col justify-center lg:justify-between lg:flex-row lg:items-center min-h-screen"}"><div class="${"leftSide w-full"}"><h1 class="${"mb-5 text-3xl md:text-4xl lg:text-5xl font-bold text-white"}">Hey! Bienvenue sur<br>Yvanig Agency
			</h1>
			<p class="${"mb-5 text-white text-md font-medium"}">Votre plus beau voyage d\xE9marre ici !</p>
			<a class="${"btn btn-primary rounded-full w-48 text-xs"}" href="${"/discover"}">D\xE9couvrir</a></div>
		<div class="${"rightSide w-full hidden lg:block"}"><div class="${"card w-full h-fit mt-20 bg-white reservation-card text-neutral svelte-1q4symm"}"><div class="${"card-body"}"><h2 class="${"card-title uppercase"}">R\xE9servez maintenant</h2>
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let loading = false;
  let flights = [];
  return `${$$result.head += `<!-- HEAD_svelte-1o5x76u_START -->${$$result.title = `<title>Yvanig Agency - Accueil</title>`, ""}<!-- HEAD_svelte-1o5x76u_END -->`, ""}
...
//# sourceMappingURL=_page.svelte-df239157.js.map
