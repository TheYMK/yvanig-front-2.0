...
const css = {
  code: ".trip-card.svelte-swr1hb{border-radius:15px;-moz-border-radius:15px;-webkit-border-radius:15px;box-shadow:0px 0px 8px 0px rgba(0, 0, 0, 0.3);border-top:solid 1px rgba(255, 255, 255, 0.1)}",
  map: null
};
const TripCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="${"trip-card w-full h-97 bg-white px-4 svelte-swr1hb"}"><div class="${"flex flex-col items-center"}"><div class="${"mt-6"}"><div class="${"w-24"}"><img${add_attribute("src", company_logo, 0)} alt="${"company logo"}" class="${"object-contain"}"></div></div>
		...
		<div class="${"mt-4"}"><span class="${"text-neutral font-bold text-xs"}">${escape(origin)} <i class="${"fa-solid fa-arrow-right"}"></i>
				${escape(destination)}</span></div>
...
//# sourceMappingURL=TripCard-b7e40c37.js.map
