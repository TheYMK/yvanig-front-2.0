...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `${$$result.head += `<!-- HEAD_svelte-1ozfw7y_START -->${$$result.title = `<title>Yvanig Agency - R\xE9s\xE9rvation</title>`, ""}<!-- HEAD_svelte-1ozfw7y_END -->`, ""}
...
//# sourceMappingURL=_page.svelte-47b66026.js.map
